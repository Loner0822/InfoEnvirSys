...
OnlyOnTheseArchitectures=Este programa s?pode ser instalado em versões do Windows preparadas para as seguintes arquitecturas:%n%n%1
MissingWOW64APIs=A versão do Windows que est?a utilizar não dispõe das funcionalidades necessárias para o Assistente de Instalação poder realizar uma instalação de 64-bit's. Para corrigir este problema, por favor instale o Service Pack %1.
...
SetupAppRunningError=O Assistente de Instalação detectou que o %1 est?em execução. Feche-o e de seguida clique em OK para continuar, ou clique em Cancelar para cancelar a instalação.
UninstallAppRunningError=O Assistente de Desinstalação detectou que o %1 est?em execução. Feche-o e de seguida clique em OK para continuar, ou clique em Cancelar para cancelar a desinstalação.

; *** Misc. errors
ErrorCreatingDir=O Assistente de Instalação não consegue criar a directoria "%1"
ErrorTooManyFilesInDir=Não ?possível criar um ficheiro na directoria "%1" porque esta contém demasiados ficheiros

; *** Setup common messages
ExitSetupTitle=Terminar a instalação
ExitSetupMessage=A instalação não est?completa. Se terminar agora, o programa não ser?instalado.%n%nMais tarde poder?executar novamente este Assistente de Instalação e concluir a instalação.%n%nDeseja terminar a instalação?
...
WelcomeLabel2=O Assistente de Instalação ir?instalar o [name/ver] no seu computador.%n%n?recomendado que feche todas as outras aplicações antes de continuar.

; *** "Password" wizard page
WizardPassword=Palavra-passe
PasswordLabel1=Esta instalação est?protegida por palavra-passe.
...
IncorrectPassword=A palavra-passe que introduziu não est?correcta. Tente novamente.

; *** "License Agreement" wizard page
WizardLicense=Contrato de licença
LicenseLabel=?importante que leia as seguintes informações antes de continuar.
...
InfoBeforeLabel=?importante que leia as seguintes informações antes de continuar.
InfoBeforeClickLabel=Quando estiver pronto para continuar clique em Seguinte.
WizardInfoAfter=Informação
InfoAfterLabel=?importante que leia as seguintes informações antes de continuar.
...
DiskSpaceMBLabel=?necessário pelo menos [mb] MB de espaço livre em disco.
ToUNCPathname=O Assistente de Instalação não pode instalar num caminho do tipo UNC. Se est?a tentar fazer a instalação numa rede, precisa de mapear a unidade de rede.
InvalidPath=?necessário indicar o caminho completo com a letra de unidade; por exemplo:%n%nC:\APP%n%nou um caminho UNC no formato:%n%n\\servidor\partilha
InvalidDrive=A unidade ou partilha UNC seleccionada não existe ou não est?acessível. Seleccione outra.
DiskSpaceWarningTitle=Não h?espaço suficiente no disco
...
InvalidDirName=O nome da pasta não ?válido.
...
MustEnterGroupName=?necessário introduzir um nome para a pasta.
GroupNameTooLong=O nome ou caminho para a pasta ?demasiado longo.
InvalidGroupName=O nome da pasta não ?válido.
...
ReadyLabel1=O Assistente de Instalação est?pronto para instalar o [name] no seu computador.
...
PreviousInstallNotCompleted=A instalação/remoção de um programa anterior não foi completada. Necessitar?de reiniciar o computador para completar essa instalação.%n%nDepois de reiniciar o computador, execute novamente este Assistente de Instalação para completar a instalação do [name].
...
FinishedRestartLabel=Para completar a instalação do [name], o Assistente de Instalação dever?reiniciar o seu computador. Deseja reiniciar agora?
FinishedRestartMessage=Para completar a instalação do [name], o Assistente de Instalação dever?reiniciar o seu computador.%n%nDeseja reiniciar agora?
...
SetupAborted=A instalação não est?completa.%n%nCorrija o problema e execute o Assistente de Instalação novamente.
...
ErrorExecutingProgram=Não ?possível executar o ficheiro:%n%1
...
ExistingFileReadOnly=O ficheiro existente tem o atributo "s?de leitura".%n%nClique em Repetir para remover o atributo "s?de leitura" e tentar novamente, Ignorar para ignorar este ficheiro, ou Abortar para cancelar a instalação.
...
ErrorRegisterServer=Não ?possível registar o DLL/OCX: %1
...
UninstallNotFound=O ficheiro "%1" não existe. Não ?possível desinstalar.
UninstallOpenError=Não foi possível abrir o ficheiro "%1". Não ?possível desinstalar.
UninstallUnsupportedVer=O ficheiro log de desinstalação "%1" est?num formato que não ?reconhecido por esta versão do desinstalador. Não ?possível desinstalar
...
UninstallOnlyOnWin64=Esta desinstalação s?pode ser realizada na versão de 64-bit's do Windows.
OnlyAdminCanUninstall=Esta desinstalação s?pode ser realizada por um utilizador com privilégios administrativos.
...
UninstalledMost=A desinstalação do %1 est?concluída.%n%nAlguns elementos não puderam ser removidos. Estes elementos podem ser removidos manualmente.
...
UninstallDataCorrupted=O ficheiro "%1" est?corrompido. Não ?possível desinstalar

; *** Uninstallation phase messages
ConfirmDeleteSharedFileTitle=Remover ficheiro partilhado?
ConfirmDeleteSharedFile2=O sistema indica que o seguinte ficheiro partilhado j?não est?a ser utilizado por nenhum programa. Deseja remov?lo?%n%nSe algum programa ainda necessitar deste ficheiro, poder?não funcionar correctamente depois de o remover. Se não tiver a certeza, seleccione Não. Manter o ficheiro não causar?nenhum problema.
